...
CREATE TABLE MEMBER(
    ...
    MEMBER_SSN CHAR(14), -- 001212-1234567
...
-- USER TABLES : 사용자가 작성한 테이블을 확인 하는 뷰
-- 데이터 딕셔너리에 정의되어 있음
...
INSERT INTO MEMBER VALUES('MEM1', 'PASS01', '홍길동', '990606-1234567', DEFAULT);
COMMIT;
...
-- 추가 샘플 데이터 삽입
INSERT INTO MEMBER VALUES('MEM2', 'PASS02', '고길동', '980707-1234567', SYSDATE);
COMMIT;

SELECT * FROM MEMBER;

-- 가입일 -> INSERT시 미작성 하는 경우
INSERT INTO MEMBER(MEMBER_ID, MEMBER_PWD, MEMBER_NAME, MEMBER_SSN)
VALUES('MEM3', 'PASS03', '오길동', '970808-1234567');
COMMIT;

SELECT * FROM MEMBER;

-- 주민등록번호의 데이터 타입을 NUMBER로 지정
CREATE TABLE MEMBER2(
    MEMBER_NAME VARCHAR2(30),
    MEMBER_SSN NUMBER);
    
INSERT INTO MEMBER2 VALUES('김영희', 9909091234567);
SELECT * FROM MEMBER2;

INSERT INTO MEMBER2 VALUES('이영희', 0009091234567);
SELECT * FROM MEMBER2;
...
CREATE TABLE USER_USED_NN(
    USER_NO NUMBER NOT NULL, -- 사용자 번호(무조건 다들 있어야 함 == NULL X)
                    --> 여기가 컬럼 레벨
    USER_ID VARCHAR2(20),
...
INSERT INTO USER_USED_NN
VALUES(null,'user01', 'pass01', '홍길동', '남', '010-1234-1234', 'hong123@kh.or.kr');
-- ORA-01400 : 오류 코드
...
INSERT INTO USER_USED_UK
VALUES(1,'user01', 'pass01', '홍길동', '남', '010-1234-1234', 'hong123@kh.or.kr');
-- ORA-00001: 무결성 제약 조건(OYJ.SYS_C008410)에 위배됩니다
...
INSERT INTO USER_USED_UK2
VALUES(3,'user01', 'pass01', '홍길동', '남', '010-1234-1234', 'hong123@kh.or.kr');

INSERT INTO USER_USED_UK2
VALUES(4,'user01', 'pass01', '홍길동', '남', '010-1234-1234', 'hong123@kh.or.kr');
--
...
-- 한 개 컬럼에 설정할 수도 있고, 여러 개의 컬럼을 묶어서 설정할 수 있음(복합키)
...
CREATE TABLE USER_USED_PK(
    ...
    -- 테이블 레벨 제약조건 설정
    CONSTRAINT USERID_USERNAME PRIMARY KEY(USER_NO)
);


INSERT INTO USER_USED_PK
VALUES(1,'user02', 'pass01', '이영희', '여', '010-5678-1234', 'lee123@kh.or.kr');

INSERT INTO USER_USED_PK
VALUES(1,'user02', 'pass01', '이영희', '여', '010-5678-1234', 'lee123@kh.or.kr');
-- ORA-00001: 무결성 제약 조건(OYJ.USER_ID_NAME_U)에 위배됩니다
--> 기본키가 중복으로 오류 발생

INSERT INTO USER_USED_PK
VALUES(NULL,'user02', 'pass01', '이영희', '여', '010-5678-1234', 'lee123@kh.or.kr');
--  ORA-01400: NULL을 ("OYJ"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
--> 기본키가 NULL이므로 오류
...
CREATE TABLE USER_USED_PK2(
    ...
    -- 테이블 레벨 제약조건 설정
    CONSTRAINT USERNO_USERID_PK PRIMARY KEY(USER_NO, USER_ID)
...
INSERT INTO USER_USED_PK2
VALUES(1,'user02', 'pass01', '김길동', '남', '010-1234-1234',  'hong123@kh.or.kr');

INSERT INTO USER_USED_PK2
VALUES(2,'user01', 'pass01', '이길동', '남', '010-1234-1234',  'hong123@kh.or.kr');

INSERT INTO USER_USED_PK2
VALUES(1,'user01', 'pass01', '홍길동', '남', '010-1234-1234',  'hong123@kh.or.kr');
-- RA-00001: 무결성 제약 조건(OYJ.USERNO_USERID_PK)에 위배됩니다
-- 회원번호와 아이디 둘다 중복 되었을 때만 제약조건 위배 에러 발생
...
INSERT INTO USER_USED_PK2
VALUES(NULL,'user01', 'pass01', '홍길동', '남', '010-1234-1234',  'hong123@kh.or.kr');
-- SQL 오류: ORA-01400: NULL을 ("OYJ"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
-- 복합키여도 PK이므로 NULL은 절대 안됨!!!
...
CREATE TABLE USER_USED_FK(
    ...
    USER_ID VARCHAR2(20) UNIQUE, -- 아이디 중복 X
    USER_PWD VARCHAR2(30) NOT NULL, -- 비밀번호 NULL X
    USER_NAME VARCHAR2(30),
    GENDER VARCHAR2(10),
    PHONE VARCHAR2(30),
    EMAIL VARCHAR2(50),
    ...
    -- 컬럼명 자료형(크기) [CONSTRAINT 이름] REFERENCES 참조할 테이블명 [(참조할컬럼)] [삭제룰]
    -- GRADE_CODE NUMBER CONSTRAINT GRADE_CODE_FK REFERENCES USER_GRADE(GRADE_CODE)-- 컬럼 레벨 FK 지정
...
INSERT INTO USER_USED_FK
VALUES(2,'user02', 'pass01', '김길동', '남', '010-1234-1234',  'hong123@kh.or.kr', 10);
-- ORA-00001: 무결성 제약 조건(OYJ.SYS_C008427)에 위배됩니다


INSERT INTO USER_USED_FK
VALUES(3,'user03', 'pass01', '이길동', '남', '010-1234-1234',  'hong123@kh.or.kr', 30);

INSERT INTO USER_USED_FK
VALUES(4,'user04', 'pass01', '이길동', '남', '010-1234-1234',  'hong123@kh.or.kr', NULL);
--> NULL 사용 가능

SELECT * FROM USER_USED_FK;

INSERT INTO USER_USED_FK
VALUES(5,'user05', 'pass01', '이길동', '남', '010-1234-1234',  'hong123@kh.or.kr', 50);
-- ORA-02291: 무결성 제약조건(OYJ.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
--> 참조 무결성 위배
...
-- * FOREIGN KEY 삭제 욥션
-- 부모 테이블의 데이터 삭제 시 자식 테이블의 데이터를 어떤 식으로 처리할 지에 대한 내용을 설정할 수 있다
...
WHERE GRADE_CODE = 10;
-- ORA-02292: 무결성 제약조건(OYJ.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
CREATE TABLE USER_USED_FK2(
    ...
    -- GRADE_CODE NUMBER CONSTRAINT GRADE_CODE_FK REFERNECES USER_GRADE2(GRADE_CODE) ON DELETE SET NULL
    GRADE_CODE NUMBER, 
...
SELECT * FROM USER_GRADE2; -- 부모테이블 삭제 확인(10 없음)

SELECT * FROM USER_USED_FK2; -- 자식테이블 NULL로 변환 확인



-- (CASCADE : 종속 예) 부모 자식 상하관계
...
CREATE TABLE USER_USED_FK3(
    ...
    GRADE_CODE NUMBER,
    FOREIGN KEY(GRADE_CODE) REFERENCES USER_GRADE3 ON DELETE CASCADE
                                                                            --> 삭제 옵션 추가
);
...
INSERT INTO USER_USED_CHECK
VALUES(2,'user02', 'pass01', '홍길동', '남자', '010-1234-1234',  'hong123@kh.or.kr');
-- ORA-02290: 체크 제약조건(OYJ.GENDER_CHECK)이 위배되었습니다
...
VALUES (1,'user01', 'pass01', '910101-1234567', '남', '010-1111-2222', '서울', 'N');
INSERT INTO USER_TEST
VALUES (2,'user02', 'pass02', '920202-1234567', '여', '010-3333-4444', '경기', 'N');
INSERT INTO USER_TEST
VALUES (3,'user03', 'pass03', '930303-1234567', '남', '010-5555-6666', '대구', 'Y');
INSERT INTO USER_TEST
VALUES (4,'user04', 'pass04', '940404-1234567', '여', '010-7777-8888', '대전', 'N');
INSERT INTO USER_TEST
VALUES (5,'user05', 'pass05', '950505-1234567', '남', '010-9999-1234', '강원', 'Y');
...
AS SELECT * FROM EMPLOYEE
    WHERE 1 = 0; -- 일부러 FALSE로 만들어서 데이터 복사가 아닌 정보만 가져오는 식으로
...
-- NOT NULL 제약 조건만 복사된 EMPLOYEE COPY 테이블에 EMP_ID 컬럼에 PRIMARY KEY 제약조건 추가
...
ALTER TABLE EMPLOYEE ADD CONSTRAINT FK_SAL_GRADE
